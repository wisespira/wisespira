...
Most of the work here is my testing of various technologies. More notable projects include my portfolio (irawatt.co.uk) built-in Angular 2 and my university project Algo2k, a PWA (Progressive Web App) built for stock trading strategy backtesting/validation with a node.js backend. Currently, I'm working on an ML project to model national electricity demand using the ESO and national weather datasets.   
